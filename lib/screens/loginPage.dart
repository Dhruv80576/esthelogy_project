...
import 'package:esthelogy_project/utils/authApi.dart';
          ...
          children: [
            ...
            FloatingActionButton.extended(
              ...
              shape: RoundedRectangleBorder(
                    ...
                    builder: (context) {
                      getUsers().then((value) {
                        for (var element in value) {
                          if(element.username==username_contr.text && element.email==password_contr.text){
                ...
                label: Text('Login')),
                SizedBox(height: 10,),
                Container(child: Text('Forgot Password?'),alignment: Alignment.center,),
                SizedBox(height:20),
                Container(child: Text('Register here'),alignment: Alignment.center,),
          ],
        ),
      ),
    ));
